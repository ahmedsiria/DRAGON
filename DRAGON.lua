...
local UserName = (data.username_ or "sonight1")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝗔𝗟𝗘𝗫")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/DRAGON/main/DRAGON.lua')
...
{{text = '𝗔𝗟𝗘𝗫', url="t.me/sonight1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '⩹━━━━━━ 𝗔𝗟𝗘𝗫 ━━━━━━⩺' or text == '⩹━━━━━━ 𝗔𝗟𝗘𝗫 ━━━━━━⩺' or text == '⩹━━━━━━ 𝗔𝗟𝗘𝗫 ━━━━━━⩺' or text == '"' then
local Text =[[
تواصل السورس ☑️
]]
keyboard = {} 
...
{
{text = '۞ قنات سورس متميزه  ۞ ', url = "https://t.me/sonight1"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sonight1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
usertext = '\n ◍ العضو » ['..result.title_..'](t.me/'..(username or 'sonight1')..')'
status  = '\n ◍ تم ترقيته مطور'
...
usertext = '\n ◍ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sonight1')..')'
status  = '\n ◍ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◍ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sonight1')..') \n ◍ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◍ العضو : {["..data.first_name_.."](T.ME/sonight1)}\n ◍ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◍ عذرا » {["..data.first_name_.."](T.ME/sonight1)}\n ◍ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
۞          [اهلان في سورس نايت🌑    ](t.me/sonight1)    ۞
...
{
{text = '🌑  مبـرمج السورس 🌑', url = "https://t.me/siria22"},
},
{
{text = '🌑 قنات سورس متميزه  🌑 ', url = "https://t.me/sonight1"}
},
...
۞- [اهلا بك في سورس نايت الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ](t.me/sonight1) ۞
...
if text == 'سوريا' or text == sare' then  
local Text = [[  
⌯ مــبـرمج الســورس  ⌯
]]  
keyboard = {}   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◍ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sonight1')..') \n ◍ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◍ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sonight1')..') \n ◍ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◍♯تم قفل البوتات بالطرد\n◍♯تم وضع الايدي بدون صوره\n◍♯تم قفل التكرار بالطرد\n◍♯تم قفل الروابط\n◍♯تم قفل التوجيه\n◍♯تم قفل الملصقات\n◍♯تم قفل المتحركه\n◍♯تم قفل الفيديو\n◍♯تم قفل السب\n◍♯تم قفل التعديل\n◍♯تم قفل الفارسيه\n◍♯تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sonight1')..')')   
end,nil) 
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/DRAGON/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◍ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sonight1')..')'
status  = '\n ◍ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◍ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◍ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sonight1')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◍ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'sonight1')..')'..'\n ◍ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."sonight1:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'◍ تم تفعيل الانستا')
database:set(bot_id.."sonight1:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."sonight1:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."sonight1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◍تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."sonight1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."sonight1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/sonight1)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sonight1)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sonight1)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sonight1)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sonight1)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂◍](t.me/sonight1)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sonight1)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه?? ](t.me/sonight1)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/sonight1)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sonight1)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/sonight1)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/sonight1)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sonight1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sonight1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/sonight1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/sonight1)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/sonight1)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/sonight1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/sonight1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/sonight1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/sonight1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/sonight1)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sonight1)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sonight1')..')'
local iduser = result.sender_user_id_
...
local Text =[[
╭────  [ 𝒂𝒍𝒆𝒙  𝒕𝒆𝒂𝒎 ꪝ   ](t.me/sonight1)  ────╮

۞ [ مبرمج السورس   ](t.me/Jiiiiiii1) ۞
             
╰────  [ 𝒂𝒍𝒆𝒙  𝒕𝒆𝒂𝒎 ꪝ  ](t.me/sonight1)  ────╯

[۞ قناه السورس ۞ ](t.me/sonight1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝗔𝗟𝗘𝗫', url="t.me/sonight1"},
{text = 'مبرمج السورس', url="t.me/sonight1"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
