...
sudo_users = {SUDO,83838383838838383838388383,1874048901,1634565473}   
...
if tonumber(user_id) == tonumber(83838383838838383838388383) then  
var = true  
...
{
{text = '۞  مبرمج ومطور السورس  ۞ ', url = "https://t.me/B_ERR"},
},
{
...
۞- [اهلا بك في سورس اليكس الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ](t.me/B_TRR) ۞
...
if text == 'اليكس' or text == 'ALEX' or text == 'alex' or text == '"' then
local Text =[[


۞- [مبرمج سورس اليكس](t.me/B_TRR) ۞
...
if text == 'العاب اليكس' or text == 'العاب مسليه' or text == 'العاب متطوره' then  
local Text = [[  
...
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "Source_Queen")}}}
